...
def analyse_metabolomique_complete():
    ...
    dossier_source = os.environ.get("OMICS_IN_DIR", r"D:\Stage-CRBS\Stage_analyses\Métabolomique")
    dossier_sortie = os.environ.get("OMICS_OUT_DIR", r"D:\Stage-CRBS\Stage_analyses\Résultats\Métabolomique")
